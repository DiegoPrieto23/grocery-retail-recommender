...
El ranker acierta algo en el **49,5 %** de las cestas de test,
frente al **26,7 %** del baseline sin aprendizaje (popularidad
reciente x indice estacional). Son **22,75 puntos** mas: un
**85 % mas de cestas con una sugerencia relevante**. Esa
...
| Paso | Valor |
| --- | ---: |
| Cestas al mes con un acierto que el baseline no daba | 22.750 |
| x incrementalidad (10 %) = unidades extra al mes | 2.275 |
| x importe medio de linea = **venta extra al mes** | **12.791 €** |
| x margen bruto = **margen extra al mes** | **3.095 €** |
| **Margen extra al ano** | **37.143 €** |

Sobre el supermercado simulado tal cual (13.651 cestas
online al mes) son 423 € al mes.
...
| ---: | ---: | ---: | ---: | ---: |
| 2 % | 455 | 2.558 € | 619 € | 7.429 € |
| 5 % | 1.137 | 6.396 € | 1.548 € | 18.572 € |
| 10 % | 2.275 | 12.791 € | 3.095 € | 37.143 € |
| 20 % | 4.550 | 25.582 € | 6.191 € | 74.287 € |
| 30 % | 6.825 | 38.373 € | 9.286 € | 111.430 € |

La lectura honesta: **el cross-sell del recomendador vale 37.143 € al ano por cada 100.000 cestas online al mes**, frente a 252.286 € del NBA por cada 100.000 clientes.
...
categoria el mismo sistema acierta en el 49,5 %
...
| Pieza | Al mes | Al ano |
| --- | ---: | ---: |
| Cross-sell del recomendador (margen) | 3.095 € | 37.143 € |
...
El reparto tambien dice donde esta hoy el proyecto: el NBA pone el **87 %** del total y el recomendador el 13 %. En parte tiene sentido — la politica decide sobre el cliente entero y el recomendador solo sobre cinco huecos de una cesta — y en parte es historia: antes de la Fase 7 el recomendador ponia solo el
