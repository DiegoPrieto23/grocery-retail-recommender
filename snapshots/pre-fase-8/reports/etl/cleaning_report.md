...
| `basket_items` | quantity negativa | Se corrige el signo: quantity = abs(quantity) | 12.314 | 0.397 % | 3.103.685 | 3.103.685 |
| `basket_items` | linea de ticket duplicada | Se elimina la fila repetida entera, despues de corregir el signo | 45.860 | 1.478 % | 3.103.685 | 3.057.825 |
| `basket_items` | duplicados que solo afloran tras corregir el signo | Diagnostico: (dedup tras signo) - (dedup sin corregir el signo) | 386 | 0.012 % | 3.103.685 | 3.057.825 |
...
| `session_events` | evento duplicado exacto | Se elimina la fila repetida entera | 79 | 0.009 % | 897.674 | 897.595 |
