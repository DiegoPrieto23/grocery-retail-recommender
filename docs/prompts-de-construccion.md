# Prompts de construcción del proyecto

Los prompts con los que se construyó este repo sesión a sesión, con Claude Code. Estaban
en `GETTING_STARTED.md`, que describía el arranque de la Fase 0 y no el proyecto que hay
hoy; se separaron en el punto B3 del [diagnóstico](diagnostico-fase7.md).

Se conservan **como se escribieron**, sin actualizar: su valor es justamente ese, dejar
ver qué se pidió en cada momento y en qué orden. Para arrancar el proyecto hoy, la guía es
