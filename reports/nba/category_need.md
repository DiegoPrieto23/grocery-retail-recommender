...
| --- | ---: | ---: | ---: | ---: | ---: |
| `enviar_cupon_categoria` | 8.849 | 1.31 | 23,2% | 2,0% | 4,3% |
| `recomendar_categoria` | 5.047 | 1.46 | 25,2% | 5,5% | 8,5% |
...
| --- | ---: | ---: | ---: | ---: |
| `enviar_cupon_categoria` | 88,5% | **23,2%** | 1,5% | **4,3%** |
| `recomendar_categoria` | 38,1% | **25,2%** | 5,6% | **8,5%** |
