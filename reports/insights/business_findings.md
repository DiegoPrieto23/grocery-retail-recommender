...
**3,38 veces** lo que pesa un mes cualquiera dentro de
...
**Panales -> Toallitas humedas** mide **16,32** frente a un
objetivo de 4,0.
...
es practicamente identico en los tres niveles (39,90 EUR en gold
frente a 39,79 EUR en bronze). **La diferencia esta entera en la
frecuencia**: 48 compras frente a 23.

El tamano del hogar, en cambio, si mueve el ticket: de 27,17 EUR
en un hogar de una persona a 64,25 EUR en uno de
6.
...
**0,969**, y se acorta de forma monotona al crecer el hogar en
las cuatro categorias dibujadas. Hoy, **51,9 %** de los
689.212 pares cliente-categoria tienen la recompra vencida, y eso alcanza
a 18.974 clientes.
...
ticket el **91,5 %**; de lo que solo se mira, el
**67,9 %**; y en sentido contrario, solo el
...
NDCG@5 = **0,2815** frente a 0,1565 del baseline sin
aprendizaje. El sistema acierta la **categoria** en el **79,5 %** de las
cestas y el **SKU exacto** en el **61,6 %**, y el pool de candidatos cubre el
82,5 % del target.

Por perfil, el peor es **2 - nuevo, con articulos** (NDCG@5 =
0,1965). Es el unico que no puede tirar ni de historial ni de ALS, y
...
(0,0200 -> 0,1565). Lo que es merito del
...
la accion y la probabilidad de churn es **-0,27** -- **negativa** --
y con el gasto de los ultimos 90 dias, **+0,63**.

| Segmento RFM | clientes | P(churn) media | gasto 90d (EUR) | valor (EUR/cliente) | con accion |
| --- | ---: | ---: | ---: | ---: | ---: |
| Campeones | 5.177 | 0,217 | 343 | 0,311 | 99,6 % |
| Fieles | 3.994 | 0,376 | 162 | 0,283 | 95,7 % |
| En riesgo | 3.352 | 0,495 | 76 | 0,166 | 57,4 % |
| Prometedores | 1.035 | 0,517 | 64 | 0,149 | 82,3 % |
| Necesitan atencion | 919 | 0,535 | 59 | 0,142 | 79,0 % |
| Hibernando | 4.252 | 0,615 | 22 | 0,061 | 35,3 % |

En el decil de mas riesgo de fuga la politica actua solo sobre el
**25 %** de los clientes y saca
0,023 EUR por cabeza; en el decil de menos riesgo actua sobre
todos y saca 0,303 EUR. El mejor segmento es
**Campeones** (0,311 EUR por cliente) y el peor,
**Hibernando** (0,061 EUR).
...
Drogueria e Higiene son el **19,2 %** de la venta y se llevan el
**44,0 %** de las acciones. Frescos, que es mas de un tercio de
la venta, se queda en un indice de **0,33**.

| Departamento | de las acciones | de la venta | margen | indice |
| --- | ---: | ---: | ---: | ---: |
| Frescos | 11,7 % | 35,3 % | 18 % | 0,33 |
| Bebe | 3,7 % | 4,1 % | 20 % | 0,90 |
| Congelados | 12,3 % | 10,0 % | 22 % | 1,23 |
| Bebidas | 5,7 % | 8,8 % | 24 % | 0,65 |
| Despensa | 13,3 % | 18,9 % | 25 % | 0,71 |
| Mascotas | 9,4 % | 3,7 % | 30 % | 2,51 |
| Drogueria | 25,6 % | 8,5 % | 35 % | 3,02 |
| Higiene | 18,4 % | 10,7 % | 35 % | 1,72 |
...
**Protector solar** (1.685 veces), que en el mes del corte
(mes 11) vende **3,7 veces menos** que en su mes
